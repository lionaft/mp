...
public class MainLogger {
    ...
    static{
        InputStream resourceAsStream = MainLogger.class.getClassLoader().getResourceAsStream("logging.properties");
    ...
    private static final Logger logger = Logger.getLogger("OSLMS");
